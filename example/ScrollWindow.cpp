        ...
        m_Button_Quit("Quit")
{
    ...
    m_CheckButton.signal_toggled().connect( sigc::mem_fun(*this,
                                                          &ScrollWindow::on_checkbutton_toggled) );
    ...
    m_ComboBox_Position.signal_changed().connect( sigc::mem_fun(*this, &ScrollWindow::on_combo_position) );
    ...
    m_adjustment_digits->signal_value_changed().connect(sigc::mem_fun(*this,
                                                                      &ScrollWindow::on_adjustment1_value_changed));
    ...
    m_adjustment_pagesize->signal_value_changed().connect(sigc::mem_fun(*this,
                                                                        &ScrollWindow::on_adjustment2_value_changed));
...
void ScrollWindow::on_adjustment1_value_changed()
{
...
void ScrollWindow::on_adjustment2_value_changed()
{
...
void ScrollWindow::on_button_quit()
{
    hide();
}